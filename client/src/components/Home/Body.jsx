...
<div className="flex items-center justify-center min-h-[500px] relative m-auto max-h-36 mt-28 ml-20 sm:m-auto">
...
>
  <h2 className="text-2xl md:text-3xl lg:text-5xl font-bold shine-text">
...
<motion.div
  ...
  transition={{ duration: 1, delay: 1.5 }}
>
  <img src={robo1} alt='robo1' className='max-w-80 hidden sm:block' />
</motion.div>
</div>

      <div className="flex items-center justify-center min-h-[500px] relative m-auto max-h-36 ml-20 sm:m-auto">
        <motion.div
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 1, delay: 2.5 }}
        >
          <img src={customer} alt='robo1' className='max-w-96 hidden sm:block' />
        </motion.div>
      ...
      <div className="flex items-center justify-center min-h-[500px] relative m-auto max-h-36 ml-20 sm:m-auto">
        ...
        >
          <h2 className="text-2xl md:text-3xl lg:text-5xl font-bold mb-4 shine-text">
        ...
        <motion.div
          ...
          transition={{ duration: 1, delay: 4 }}
        >
          <img src={costrobo} alt='robo1' className='max-w-96 hidden sm:block' />
        </motion.div>
      </div>
       <Demo />
